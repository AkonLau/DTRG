...
class ImageLoader(torch.utils.data.Dataset):
    ...
    def __init__(self, root='Stanford_Cars', transform=None, target_transform=None, train=False, loader=pil_loader):
        ...
        img_folder = root
        pd_train = pd.DataFrame.from_dict(get_mat_frame(os.path.join(root, 'devkit', 'cars_train_annos.mat'), 'images/cars_train'))
        pd_test = pd.DataFrame.from_dict(get_mat_frame(os.path.join(root, 'devkit', 'cars_test_annos_withlabels.mat'), 'images/cars_test'))
