...
def get_dataset(conf):
    ...
    ds_train = DTD(root=datadir, split='train', partition=conf.partition, transform=transform_train)

    ds_test =DTD(root=datadir, split='test', partition=conf.partition, transform=transform_test)
